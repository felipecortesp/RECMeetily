...
const README: &str = "RECMeetily crash report\n\
\n\
Included:\n\
- Crash type, time, and anonymous report ID\n\
- RECMeetily version and selected acceleration backend\n\
...
- RECMeetily's database, settings, or WebView storage\n\
...
pub fn install_panic_hook() {
    ...
    std::panic::set_hook(Box::new(move |info| {
        ...
        log::error!("RECMeetily encountered a panic; a local crash record was written");
        previous(info);
    }));
}
